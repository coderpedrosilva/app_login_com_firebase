...
class _EditJobPageState extends State<EditJobPage> {
      ...
      try {
        ...
        if (allNames.contains(_name)) {
          showAlertDialog(
            context,
            title: 'Nome já usado',
            content: 'Por favor escolha outro nome de atividade',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 2.0,
        title: Text(widget.job == null ? 'Nova atividade' : 'Editar atividade'),
        actions: [
          FlatButton(
            child: Text(
              'Salvar',
  ...
  List<Widget> _buildFormChildren() {
    return [
      TextFormField(
        ...
        initialValue: _name,
        validator: (value) =>
            value.isNotEmpty ? null : 'Nome não pode ficar vazio',
